...
export class PatientConsultationComponent implements OnInit {
  ...
  getRecentVisitTime() {
    ...
    let doctorId = this.recentVisit && this.recentVisit.medicalReferenceEntity && this.recentVisit.medicalReferenceEntity.consultation ? this.recentVisit.medicalReferenceEntity.consultation.doctorId : '';
