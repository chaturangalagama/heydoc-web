  ...
  reportCategories: [
    {
      ...
      reports: [
        {
          reportName: 'daily_queue_list',
          reportDisplayName: 'Daily Queue List',
    ...
    },
    {
      ...
      reports: [
        ...
        {
          reportName: 'revenue_analysis_report',
          reportDisplayName: 'Revenue Analysis Report',
          params: ['startDate', 'endDate'],
          roles: ['ROLE_REVENUE_ANALYSIS_REPORT']
        }
      ]
    },
    {
