import { ConsultationComponentsModule } from '../../../../components/business-components/consultation/consultation-components.module';
import { PaymentRoutingModule } from '../payment/payment-routing.module';
import { PaymentComponentsModule } from '../../../../components/business-components/payment/payment-components.module';
import { CommonModule } from '@angular/common';
import { NgModule } from '@angular/core';
import { FormsModule, ReactiveFormsModule } from '@angular/forms';
import { BsDatepickerModule } from 'ngx-bootstrap/datepicker';

import { PatientDetailComponentsModule } from '../../../../components/business-components/patient-detail/patient-detail-components.module';
import { PatientDetailLayoutComponent } from '../../../../containers/patient-detail-layout';
import { PatientAddComponentsModule } from '../../../../components/business-components/patient-add/patient-add-components.module';
...
import { DynamicFormContainerComponent } from '../../../../components/app-components/dynamic-form-container/dynamic-form-container.component';
@NgModule({
  imports: [
    CommonModule,
